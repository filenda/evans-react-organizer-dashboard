...
/* END STYLE DO TEMPLATE */

/* INICIO MODERN DASHBOARD */



/*----------------------------------------
  Modern Dashboard (STYLE DO TEMA)
------------------------------------------*/
.chartist-tooltip
{
...
#user-statistics-bar-chart .ct-series-a .ct-slice-pie
{
    -webkit-animation: barChart .2s forwards ease-in;
       -moz-animation: barChart .2s forwards ease-in;
         -o-animation: barChart .2s forwards ease-in;
...
/* ESTILOS ADICIONAIS NA PAGINA - NÃO É NATIVO DO MATERIALIZE EU QUE INCLUI */
...
/*start - todo: filenga*/
/* USO O CHARTLIST PLUGIN TOOLTIP PARA OS MINI GRAFICOS DA DASH */
.chartist-tooltip {
  position: absolute;
  display: inline-block;
  opacity: 0;
